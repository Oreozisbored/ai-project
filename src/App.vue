...
export default {
  ...
  async mounted() {
    ...
    this.model = this.genAI.getGenerativeModel({
      ...
      systemInstruction: `Your primary function is to serve as an educational assistant for students in middle school (5th grade) and above. You are strictly prohibited from deviating from this purpose.
